...
NEGATIVE_CORPUS_SIZE = 5000 # size of negative corpus for generating soft negatives for triplets
TRAINING_CORPUS_SIZE_PER_EPOCH = 5000
VAL_CORPUS_SIZE = 500 # size of corpus of validation sets, per task
